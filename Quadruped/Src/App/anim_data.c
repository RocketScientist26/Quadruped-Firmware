...
const anim_data_t anim_data_swim_s = {
	.data = {
		...
		47, ANIM_DATA_CA_H, 15, 47, 47, 55, ANIM_DATA_CA_H, 25
	},
	.poses = 8,
	.loop = ANIM_DATA_ONCE,
	.max_substep = 0.25,
...
const anim_data_t anim_data_swim_l = {
	.data = {
		47, ANIM_DATA_CA_H, 15, 47, 47, 55, ANIM_DATA_CA_H, 25,
		25, ANIM_DATA_CA_H, 28, 25, 47, 41, ANIM_DATA_CA_H, 47,
		47, ANIM_DATA_CA_H, 41, 25, 47, 28, ANIM_DATA_CA_H, 25,
		25, ANIM_DATA_CA_H, 55, 25, 47, 15, ANIM_DATA_CA_H, 47,

		47, ANIM_DATA_CA_H, 55, 25, 25, 15, ANIM_DATA_CA_H, 25,
		25, ANIM_DATA_CA_H, 41, 47, 25, 28, ANIM_DATA_CA_H, 47,
		47, ANIM_DATA_CA_H, 28, 47, 25, 41, ANIM_DATA_CA_H, 25,
		25, ANIM_DATA_CA_H, 15, 47, 25, 55, ANIM_DATA_CA_H, 47
	},
	.poses = 8,
	.loop = ANIM_DATA_LOOP,
	.max_substep = 0.3,
